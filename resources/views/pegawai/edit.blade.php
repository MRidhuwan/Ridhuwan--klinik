        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="float-left"><a href="{{ route('pegawai.show', $pegawai->id) }}" class="btn btn-success btn">
                            Kembali </a>
                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="NIP"
                                            placeholder="Nomor Induk Pegawai" required value="{{ $pegawai->NIP }}" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="nama_pegawai"
                                            placeholder="Nama Pegawai" required value="{{ $pegawai->name }}" />
                                    </div>
                                </div>
                                        ...
                                        <select class="select2_single form-control" name="id_wilayah" tabindex="-1">
                                            @foreach ($wilayah as $wil)
                                                @if ($pegawai->id_wilayah == $wil->id)
                                                    <option value="{{ $wil->id }}" selected="selected">
                                                        {{ $wil->nama_wilayah }}
                                                    </option>';
                                                @else
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="email" name="email"
                                            placeholder="Email Pegawai" required value="{{ $pegawai->email }}" />
                                    </div>
                                </div>
