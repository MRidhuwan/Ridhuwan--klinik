            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="x_panel">
                        ...
                        {{-- {{ dd($pegawai) }} --}}
                        <div class="x_content">
                            <form action="{{ route('pegawai.show', $pegawai->id) }}" method="post">

                                @csrf
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="NIP">NIP :
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="NIP"
                                            placeholder="Nomor Induk Pegawai" readonly value="{{ $pegawai->NIP }}" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="nama_pegawai"
                                            placeholder="Nama Pegawai" readonly value="{{ $pegawai->name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" name="tempat_lahir"
                                            placeholder="Tempat Lahir Pegawai" readonly
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="email" name="email"
                                            placeholder="Email Pegawai" readonly value="{{ $pegawai->email }}" />
                                    </div>
                                </div>
