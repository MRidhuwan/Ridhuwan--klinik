...
<head>
    ...
    <title>Klinik Test Coding</title>
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{ url('/') }}" class="site_title"><i class='fa fa-stethoscope'></i> <span>Klinik Test Coding</span></a>
                    </div>
                    ...
                    <div class="profile clearfix">
                        <div class="profile_info ml-3">
                            ...
                            @endcan
                            @can('isSuperAdmin')
                            <span><b>{{ Auth::user()->name }}</b><br></span>
                            <a style="font-size:10px"> {{ Auth::user()->created_at }}</a>
                            @endcan
                        </div>
                        <div class="clearfix"></div>
                    </div>
